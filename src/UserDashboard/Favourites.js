  ...
  console.log('wish list',wishlist.length);
	...
	return (
		<div>
			...
			<div>
        {flag && wishlist.map((wish) => (
                 <Link to={`/spp/${wish.key}`} className="RjPropertiesLInk bg-default">
                    ...
                    <div class="row g-0">
                      ...
                      <div class="col-sm-12 col-md-8">
                        <div class="card-body">
                          ...
                          <span>{bed} {wish.bed}</span>&nbsp;&nbsp;<span>{bath} {wish.bath}</span>
                          &nbsp;&nbsp;
                          <span>
                            {objectGroup} {wish.size}<sup>2</sup>{" "}
                          </span>
