...
import Image1 from '../../images/HomeLoan.jpeg';
    ...
    return (
        <div className={Styles.HomeLoan}>
            ...
            <section className="container my-5 pt-5">
                ...
                <p
                    className="text-center px-5 mx-3">
                    Home is where our dreams begin. Home is where your happiness starts. Home is shelter to every phase of your life. IDLC Apartment Purchase Loan gives you the confidence to purchase your own space and live in full freedom.
                </p>
                {/* Tabs */}
                <ul class="nav nav-pills mb-3 row mt-5 gy-2" id="pills-tab" role="tablist">
                    {/* Buttons */}
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    >
                        <ul>
                            <li>Loan Tenure: Up to 25 years loan term</li>
                            <li>Loan Amount: Up to 80% of the apartment price including Registration costs</li>
                            <li>Customers can take a loan to purchase an apartment without incurring registration costs.</li>
                            <li>Full/partial early payment option of the loan amount before expiry.</li>
                    ...
                    >
                        ...
                        <ul>
                            <li>You should have regular income from a sustainable & valid source of employment or business.</li>
                            <li>The Age of the main income earner should be within 65 years at the end of the proposed loan tenure.</li>
                            <li>The Apartment being purchased should be eligible & enforceable security.</li>
                        </ul>
                        {/* Apply Button */}
                        <button
                            className={Styles.ApplyButton}>
                    ...
                    >
                        <p>
                            You can use this loan to purchase an appartment for individual ownership.
                        </p>
                        {/* Apply Button */}
                        <button
                            className={Styles.ApplyButton}>
                    ...
                    >
                        <p>
                            You will require some mandatory & supplementary documents to avail this loan. To know more details about the required documents of the Apartment Purchase Loan download the following PDF.
                        </p>
                        {/* Apply Button */}
                        <button
                            className={Styles.ApplyButton}>
                ...
                <div className="row">
                    ...
                    <div className={
                        ...
                        <div>
                            ...
                            <button
                                className={
                                    `${Styles.CalculatorFormOutputButton} 
                                    ${Styles.Buttons}`
                                }>
                                Apply Now
                            </button>
